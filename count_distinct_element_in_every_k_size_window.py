...
LINK : https://www.naukri.com/code360/problems/count-distinct-element-in-every-k-size-window_920336?leftPanelTabValue=PROBLEM
"""
...
def countDistinctElements(arr, k):
    ...
    # Initialize the hashmap with the first k elements
    for i in range(k):
        if hm[arr[i]] == 0:
            distinct_count += 1
        hm[arr[i]] += 1
